    ...
    return (
        ...
        >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div style={{
                    padding: isSmall ? '0.625rem' : '0.75rem',
                    borderRadius: '12px',
                    background: gradient,
                    color: 'white',
                    boxShadow: '0 8px 16px -4px rgba(0,0,0,0.1)'
                }}>
                    <Icon size={isSmall ? 20 : 24} />
                </div>
                <div style={{ textAlign: 'right' }}>
                    <p style={{ fontSize: isSmall ? '0.75rem' : '0.875rem', fontWeight: 600, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.025em' }}>{title}</p>
                    <h3 style={{ fontSize: isSmall ? '1.5rem' : '1.875rem', fontWeight: 800, color: '#1e293b', margin: '0.25rem 0' }}>{value}</h3>
                </div>
            </div>
