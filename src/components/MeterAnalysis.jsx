...
export default function MeterAnalysis({ ocrStatusFilter, user, canDo = () => true }) {
    ...
    return (
        <div style={{ animation: 'fadeIn 0.5s ease-out', display: 'flex', flexDirection: 'column', flex: 1 }}>
                                        ...
                                        <tr key={rec.id}>
                                            ...
                                            <td className="no-print sticky-col-right" style={{ textAlign: 'center' }}>
                                                <div style={{ display: 'flex', gap: '0.4rem', justifyContent: 'center' }}>
                                                    ...
                                                    {canDo(ocrStatusFilter === 'REVIEW' ? 'analisa_review' : 'analisa', 'U') && (
            ...
            <SimpleImageViewer
                ...
                imageSrc={simplePreviewImage && simplePreviewImage.startsWith('/') ? `${IMAGE_BASE_URL}${simplePreviewImage}` : simplePreviewImage}
            />
